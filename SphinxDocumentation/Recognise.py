...
class Recognise:
    '''
    This class is authorization of facial recognition.

    '''
    @staticmethod
    def recognisePerson():
        '''
        This function identify facial features and compare to the existing database
           ...
           # loop over the recognized faces
            for name in names:
                ...
                if name != 'Unknown':
                    ...
                    print('Person unkonwn! Waiting for three seconds to try again...' + str(counter) + "/" + "3")
                    counter += 1  
                    time.sleep(3.0)
                # Set a flag to sleep the cam for fixed time
                if(counter == 4):
                    print("Person undefined, back to menu!")
                    return 'Unknown'
