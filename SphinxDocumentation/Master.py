class Master:
    'This class is the the mian control interface of the library system.'
    def menu(self,userName):
        '''
        This function is to generate a main menu interface.
           Args:
    ...
    def searchBook(self, userName, cloudDB):
        '''
        This function is to search books for users.
           Args:
            param1:Current Object.

            param2:User name

            param3:Cloud Database
        ...
        if choose == 2:
            ...
            cloudDB.searchBook('Title', bookName)
        else:
            searchType = TakeInput.inputBookSearchType()
            data = input('Please enter the search data:')
            bookResultNum, bookId = cloudDB.searchBook(searchType, data)
            opt = ""
            if bookResultNum == 1:
    ...
    def borrowBook(self, cloudDB, userName, bookID = -1):
        '''
        This function is to borrow books for users.
           Args:
            param1:Current Object.

            param2:Cloud Database 
    ...
    def connection(self):
        '''
        This function is to connect to the cloud database server.
           Args:
            param1:Current Object.
        '''
