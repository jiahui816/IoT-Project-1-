class TakeInput:
    'This class use regualr expresstion to validate user input.'
    @staticmethod
    def inputString(msg, inputType):
        '''
        This function is to examine user's input.
           Args:
            param1:user input information

            param2:User's input type
           Returns:
            return user input information
        '''
        isValid = False
        info = input(msg)#return user input information
    ...
    def inputInteger(min,max):     
        '''
        This function is to check user' input if an valid integer number or not.
           Args:
            param1:Minimum integer number

            param2:Creat maximum integer number
           Returns:
            An valid integer number
        '''
        isValid = False
    ...
    def inputBookSearchType():
        '''
        This function allow user to search books by type.
        '''
        while True:
